...
class Events
{
    ...
    {
        $sql = "CREATE TABLE IF NOT EXISTS `oepaypal_order` (
    ...
    public static function addPaymentMethod()
    {
        ...
        if (!$payment->load('oxidpaypal')) {
            ...
            $language = \OxidEsales\Eshop\Core\Registry::get(\OxidEsales\Eshop\Core\Language::class);
    ...
    {
        $sql = "CREATE TABLE IF NOT EXISTS `oepaypal_orderpayments` (
    ...
    {
        $sql = "CREATE TABLE IF NOT EXISTS `oepaypal_orderpaymentcomments` (
    ...
    public static function enablePayPalRDFA()
    {
        ...
        $sql = "INSERT IGNORE INTO `oxobject2payment` (`OXID`, `OXPAYMENTID`, `OXOBJECTID`, `OXTYPE`) VALUES('oepaypalrdfa', 'oxidpaypal', 'PayPal', 'rdfapayment')";
        \OxidEsales\Eshop\Core\DatabaseProvider::getDb()->execute($sql);
    }
    ...
    {
        $sql = "DELETE FROM `oxobject2payment` WHERE `OXID` = 'oepaypalrdfa'";
