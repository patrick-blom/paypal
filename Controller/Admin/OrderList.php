...
class OrderList extends OrderList_parent
{
    ...
    {
        $sql = parent::_buildSelectString($listObject);

        $paymentTable = \OxidEsales\Eshop\Core\TableViewNameGenerator::getViewName("oxpayments");
        ...
        LEFT JOIN `" . $paymentTable . "` AS `payments` on `payments`.oxid=oxorder.oxpaymenttype ";

        $sql = str_replace('from oxorder', $sQ, $sql);
